...
public class Utils{
    public final static int HEADER_COMMAND = 0;
    public final static int HEADER_SEQ = 1;
    public final static int HEADER_ACK = 5;
    public final static int HEADER_WINDOW = 9;
    public final static int HEADER_DATASIZE = 13;
    public final static int HEADER_DATA = 17;
    public final static int MAX_SEG_SIZE = 10240; //最大传输单元 (暂定为1KB) 
